...
class IdentitySignInPage extends StatefulWidget {
  @override
  _IdentitySignInPageState createState() => new _IdentitySignInPageState();
}

// The application's login page state.
class _IdentitySignInPageState extends State<IdentitySignInPage> {
  // Identity access.
    ...
    _onUrlChanged = flutterWebviewPlugin.onUrlChanged.listen((String url) {
      if (mounted) {
        setState(() {
          ...
          if (url.startsWith(
              _identityRepository.cognitoUserPoolLoginRedirectUrl)) {
  ...
  Widget build(BuildContext context) {
    String loginUrl = _identityRepository.cognitoUserPoolLoginUrl;
